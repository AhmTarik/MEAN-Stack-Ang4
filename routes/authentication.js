...
module.exports = (router) => {
            ...
            if (err) {
              ...
              if (err.code === 11000) {
                ...
                if (err.errors) {
                  ...
                  res.json({ success: false, message: 'Could not save user. Error: ', err1: err }); // Return error if not related to validation
                }
              }
            } else {
  ...
  router.get('/checkemail/:email',(req,res)=>{
    if(!req.params.email){
      res.json({ success: false, message: 'E-mail was not provide'})
    }else{
